...
public class PriorityQ {
    ...
    public int size(){ return size; }       // return number of items
    ...
    public int find(int findDex){           // find item with specified destinationVertex value
        for(int j=0; j<size; j++)
            if(queArray[j].destinationVertex == findDex)
                return j;
        return -1;
    }
}   // end class PriorityQ
